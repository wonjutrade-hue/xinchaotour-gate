...
export const GOLF_AND_FREE_CATALOG: Product[] = [
  ...
  // 1. 다낭 + 호이안 + 바나힐 (3박 5일)
  {
    ...
    priceVND: 7200000,
    duration: '3박 5일',
    imageUrl: "/images/mykhe_beach.jpg",
    additionalImages: [
  ...
  // 6. 호치민 + 무이네 사막 (3박 5일)
  {
    ...
    priceVND: 7600000,
    duration: '3박 5일',
    imageUrl: "/images/saigon_skyline_city.jpg",
    additionalImages: [
  ...
  // 7. 푸꾸옥 남부 + 북부 완전일주 (3박 5일)
  {
    ...
    priceVND: 8500000,
    duration: '3박 5일',
    imageUrl: "/images/phuquoc_grandworld.jpg",
    rating: 5.0,
    reviewCount: 230,
    isPopular: true,
  ...
  // 1) BRG 다낭 골프 리조트 18홀
  {
    ...
    priceVND: 4500000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_brg_danang.jpg",
    rating: 5.0,
    reviewCount: 320,
    isPopular: true,
    isHotDeal: true,
  ...
  // 2) 몽고메리 링크스 18홀
  {
    ...
    priceVND: 4400000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_montgomerie_danang.jpg",
    rating: 4.9,
    reviewCount: 285,
    isPopular: true,
    departureCities: ['현지 출발 (다낭/호이안 호텔 픽업)'],
  ...
  // 3) 바나힐스 골프클럽 18홀 (나이트골프 지원)
  {
    ...
    priceVND: 4650000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_banahills.jpg",
    rating: 5.0,
    reviewCount: 310,
    isPopular: true,
  ...
  // 4) 호이아나 쇼어스 골프클럽 18홀
  {
    ...
    priceVND: 5000000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_hoiana_shores.jpg",
    rating: 5.0,
    reviewCount: 260,
    isPopular: true,
    departureCities: ['현지 출발 (다낭/호이안 호텔 픽업)'],
  ...
  // 5) 빈펄 골프 남호이안 18홀
  {
    ...
    priceVND: 4100000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_vinpearl_namhoian.jpg",
    rating: 4.9,
    reviewCount: 215,
    departureCities: ['현지 출발 (다낭/호이안 호텔 픽업)'],
  ...
  // 6) 라구나 랑코 골프클럽 18홀 (닉 팔도 코스)
  {
    ...
    priceVND: 4550000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_laguna_langco.jpg",
    rating: 5.0,
    reviewCount: 190,
  ...
  // 7) [나트랑 1일 18홀] KN 골프링크스 깜란
  {
    ...
    priceVND: 4550000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_kn_links_camranh.jpg",
    rating: 5.0,
    reviewCount: 275,
    isPopular: true,
  ...
  // 8) [하노이 1일 18홀] 스카이레이크 리조트 & CC
  {
    ...
    priceVND: 4500000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_skylake_hanoi.jpg",
    rating: 5.0,
    reviewCount: 290,
    isPopular: true,
  ...
  // 9) [호치민 1일 18홀] 탄손넛 골프코스
  {
    ...
    priceVND: 4300000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_tansonnhat_saigon.jpg",
    rating: 4.9,
    reviewCount: 240,
  ...
  // 10) [달랏 1일 18홀] 달랏 팰리스 골프클럽
  {
    ...
    priceVND: 4400000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_dalat_palace.jpg",
    rating: 5.0,
    reviewCount: 220,
    isPopular: true,
  ...
  // 11) [푸꾸옥 1일 18홀] 빈펄 골프 푸꾸옥
  {
    ...
    priceVND: 4500000,
    duration: '1일 (18홀)',
    imageUrl: "/images/golf_vinpearl_phuquoc.jpg",
    rating: 4.9,
    reviewCount: 205,
  ...
  // 1) 다낭/호이안 3대 명문 54홀 3박 5일 (BRG 다낭 + 몽고메리 + 호이아나 쇼어스)
  {
    ...
    priceVND: 18400000,
    duration: '3박 5일',
    imageUrl: "/images/golf_danang_3courses.jpg",
    additionalImages: [
  ...
  // 2) 다낭/호이안 프리미엄 54홀 3박 5일 (바나힐스 + 빈펄 남호이안 + 몽고메리)
  {
    ...
    priceVND: 18000000,
    duration: '3박 5일',
    imageUrl: "/images/golf_danang_banahills_combo.jpg",
    additionalImages: [
  ...
  // 3) 나트랑/깜란 3대 코스 54홀 3박 5일 (KN 링크스 + 빈펄 나트랑 + 다이아몬드베이)
  {
    ...
    priceVND: 18200000,
    duration: '3박 5일',
    imageUrl: "/images/golf_nhatrang_combo.jpg",
    rating: 5.0,
    reviewCount: 260,
    isPopular: true,
    isHotDeal: true,
  ...
  // 4) 하노이/북부 3대 명문 54홀 3박 5일 (스카이레이크 + 롱비엔 + 피닉스 CC)
  {
    ...
    priceVND: 18400000,
    duration: '3박 5일',
    imageUrl: "/images/golf_hanoi_combo.jpg",
    rating: 4.9,
    reviewCount: 230,
    isPopular: true,
    departureCities: ['인천', '부산', '대구', '청주'],
  ...
  // 5) 호치민/남부 3대 챔피언십 54홀 3박 5일 (탄손넛 + 투득 + 트윈도브스)
  {
    ...
    priceVND: 17800000,
    duration: '3박 5일',
    imageUrl: "/images/golf_saigon_combo.jpg",
    rating: 4.9,
    reviewCount: 210,
    isPopular: true,
    departureCities: ['인천', '부산'],
  ...
  // 6) 달랏 고원 피서 골프 54홀 3박 5일 (달랏 팰리스 + 삼투옌람 + 달랏 1200)
  {
    ...
    priceVND: 18200000,
    duration: '3박 5일',
    imageUrl: "/images/golf_dalat_highland.jpg",
    rating: 5.0,
    reviewCount: 195,
    isPopular: true,
    departureCities: ['인천', '부산'],
  ...
  // 7) 푸꾸옥 오션뷰 54홀 3박 5일
  {
    ...
    priceVND: 18400000,
    duration: '3박 5일',
    imageUrl: "/images/golf_phuquoc_ocean.jpg",
    rating: 5.0,
    reviewCount: 180,
    isPopular: true,
    departureCities: ['인천', '부산', '청주'],
