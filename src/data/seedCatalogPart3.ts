...
export const COMPREHENSIVE_CATALOG_PART3: Product[] = [
  ...
  },
  {
    ...
    title: '[나트랑·달랏 콤보/3박5일 단독투어] 나트랑 오션 힐링 & 달랏 고원 감성 3박 5일 2개 도시 힐링',
    subTitle: '나트랑 5성급 비치 호텔 1박 + 달랏 5성급 호텔 2박 + 핵심 명소 올포함',
    category: '추천패키지',
    region: '남부',
    city: '달랏',
    priceKRW: 820000,
    ...
    isHotDeal: false,
    departureCities: ['인천', '부산'],
    tags: ['#나트랑달랏', '#2개도시', '#콤보패키지', '#3박5일', '#바다와고원'],
    description: '나트랑의 푸른 바다와 달랏의 시원한 고원 감성을 3박 5일 동안 알차게 둘러보는 실속 만점 결합 상품입니다.',
    included: [
      '나트랑 5성급 1박 + 달랏 5성급 2박 (조식 포함)',
    ...
    itinerary: [
      {
        ...
        description: '나트랑 깜란 국제공항 도착 후 전용 차량 기사 미팅, 5성급 호텔 체크인 및 해변 휴식.',
        meal: '석식: 해산물',
        hotel: '나트랑 5성급 호텔'
      },
      {
        ...
        description: '머드스파 힐링 후 아름다운 산악 풍경 도로를 지나 봄의 도시 달랏 도착, 야시장 및 시내 관광.',
      ...
      },
      {
        ...
        description: '달랏 핵심 명소 투어 (랑비앙산 지프, 다딴라 폭포 알파인 루지, 쑤언흐엉 호수 전망 카페).',
        meal: '조식: 호텔식 | 중식: 바베큐 | 석식: 이탈리안',
        hotel: '달랏 5성급 호텔'
      },
      {
        day: 4,
        title: '달랏 시내 관광 ➔ 깜란 공항 이동 ➔ 공항 샌딩 (기내박)',
        description: '린푸억 사원 및 기념품 쇼핑 후 깜란 공항으로 이동, 심야 귀국 항공편 탑승.',
        meal: '조식: 호텔식 | 중식: 쌀국수 | 석식: 기내식',
        hotel: '기내박'
      },
      {
        day: 5,
        title: '인천/부산 국제공항 도착 ➔ 개별 해산',
        description: '아침 인천/부산 국제공항 도착 후 개별 해산. (즐겁고 편안했던 나트랑·달랏 콤보 투어 완료)',
        meal: '조식: 기내식 또는 개별식',
        hotel: '귀국'
      }
    ]
  ...
  {
    id: 'prod-dalat-pkg-03',
    title: '[나트랑·달랏 콤보/4박6일 단독투어] 나트랑 2박 + 달랏 2박 오션&고원 4박 6일 여유만점 단독 힐링팩',
    subTitle: '나트랑 5성급 호텔 2박 + 달랏 5성급 호텔 2박! 해변 휴양과 고원 감성을 모두 여유롭게',
    category: '추천패키지',
    region: '남부',
    city: '달랏',
    priceKRW: 990000,
    ...
    imageUrl: "/images/dalat_spring_lake_1787099173538.jpg",
    additionalImages: [
      "/images/dalat_spring_lake_1787099173538.jpg",
      "https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=1200&q=80"
    ],
    rating: 5.0,
    reviewCount: 94,
    ...
    isHotDeal: false,
    departureCities: ['인천', '부산'],
    tags: ['#나트랑달랏', '#2개도시', '#4박6일', '#콤보패키지', '#바다와고원', '#단독힐링'],
    description: '나트랑 에메랄드 해변에서 2박, 시원하고 낭만적인 달랏 고원에서 2박! 이동 부담 없이 두 도시의 최고 인기 명소를 완벽히 섭렵하는 4박 6일 프리미엄 단독 투어입니다.',
    included: [
      '나트랑 5성급 오션뷰 리조트/호텔 2박 (조식 뷔페 포함)',
      '달랏 5성급 럭셔리 호텔/리조트 2박 (조식 뷔페 포함)',
      '전 일정 단독 전용 리무진 밴 차량 & 베테랑 전담 기사',
      '신짜오투어 한국어 전문 가이드 전 일정 풀케어',
      '나트랑 전용 스피드보트 호핑투어 (스노클링 장비 포함)',
      '아이리조트 프라이빗 미네랄 머드온천 스파',
      '달랏 랑비앙산 4WD 지프차 + 다딴라 폭포 알파인 코스터 루지 입장권',
      '전 일정 식사 (랍스터 씨푸드 BBQ, 달랏 소고기 핫팟, 넴느엉 등 특식)',
      '1억원 해외여행자보험'
    ],
    excluded: [
      '국제선 왕복 항공권 (실시간 최저가 발권 지원 가능)',
      '기사/가이드 매너팁 (자율)',
      '개인 경비 및 음료'
    ],
    itinerary: [
      {
        day: 1,
        title: '인천/부산 출발 ➔ 나트랑 깜란 공항 도착 ➔ 5성급 호텔 체크인',
        description: '깜란 국제공항 도착 후 전담 가이드 미팅. 전용 차량으로 5성급 호텔 이동 후 체크인 및 해변 휴식.',
        meal: '석식: 나트랑 전통 쌀국수 및 현지식',
        hotel: '나트랑 5성급 비치 호텔 (1박)'
      },
      {
        day: 2,
        title: '단독 스피드보트 산호섬 호핑투어 ➔ 아이리조트 머드온천 ➔ 랍스터 BBQ 디너',
        description: '전용 보트로 청정 산호섬에서 스노클링 및 해변 휴양. 오후에는 따뜻한 미네랄 머드온천에서 피로를 풀고 저녁 싱싱한 랍스터 해산물 BBQ 만찬.',
        meal: '조식: 호텔 뷔페식 | 중식: 해상 신선 해산물 중식 | 석식: 랍스터 씨푸드 BBQ',
        hotel: '나트랑 5성급 비치 호텔 (2박)'
      },
      {
        day: 3,
        title: '포나가르 참탑 ➔ 산악 도로 드라이브 ➔ 달랏 이동 ➔ 달랏 5성급 체크인 ➔ 쑤언흐엉 호수 & 야시장',
        description: '나트랑의 유서 깊은 포나가르 사원 관람 후 구름 고원 도로를 지나 달랏 도착. 5성급 호텔 체크인 후 낭만적인 야시장 및 쑤언흐엉 호수 산책.',
        meal: '조식: 호텔 뷔페식 | 중식: 반쎄오 & 넴느엉 특식 | 석식: 달랏 전통 소고기 핫팟(Lau Bo)',
        hotel: '달랏 5성급 호텔/리조트 (1박)'
      },
      {
        day: 4,
        title: '랑비앙산 4WD 지프 사파리 ➔ 다딴라 폭포 루지 ➔ 크레이지하우스 & 감성 숲속 카페',
        description: '지프차로 랑비앙산 정상 등정, 숲속을 가르는 알파인 코스터 루지 체험. 건축 명소 크레이지하우스와 달랏 고원 전망 카페에서 여유로운 티타임.',
        meal: '조식: 호텔 뷔페식 | 중식: 로컬 산채 바베큐 정식 | 석식: 달랏 와인 & 현지 특식',
        hotel: '달랏 5성급 호텔/리조트 (2박)'
      },
      {
        day: 5,
        title: '린푸억 모자이크 사원 ➔ 달랏 기차역 ➔ 깜란 공항 이동 ➔ 귀국편 탑승 (기내박)',
        description: '화려한 도자기 사원 린푸억과 프랑스풍 달랏 기차역 방문, 기념품 쇼핑 후 깜란 공항으로 이동하여 심야 귀국 항공편 탑승.',
        meal: '조식: 호텔 뷔페식 | 중식: 달랏 특식 | 석식: 공항 인근 깔끔한 한정식/현지식',
        hotel: '기내박 (귀국편)'
      },
      {
        day: 6,
        title: '인천/부산 국제공항 도착 ➔ 개별 해산',
        description: '이른 아침 한국 공항 도착 후 개별 해산. (풍성하고 여유로웠던 나트랑 2박 + 달랏 2박 여행 완료)',
        meal: '조식: 기내식',
        hotel: '귀국'
      }
    ]
