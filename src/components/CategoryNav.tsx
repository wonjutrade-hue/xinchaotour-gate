...
export const CategoryNav: React.FC<CategoryNavProps> = ({
  ...
  return (
    <div className="bg-slate-50 border-y border-slate-200/80 pt-14 pb-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-5">
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs space-y-3">
          <div className="flex items-center gap-2 pb-2 border-b border-slate-100">
            ...
            <span className="text-xs font-bold text-slate-800">베트남 지역 및 주요 도시 선택</span>
          </div>

          <div className="flex flex-col md:flex-row items-start md:items-center gap-3 justify-between">
            {/* Region buttons */}
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-xs font-extrabold text-slate-500 mr-1">지역:</span>
            ...
            {/* Sorting selector */}
            <div className="flex items-center gap-2 text-xs font-medium text-slate-600 self-end md:self-auto">
