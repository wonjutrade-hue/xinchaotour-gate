...
// 여행사 스타일 단독 자유여행 포함 & 불포함 프리셋 (다낭 3박4일/3박5일 기준)
const FREE_TOUR_INCLUDED = [
  '다낭 5성급 프리미엄 호텔/리조트 숙박 (2인 1실, 매일 호텔 조식 뷔페 포함)',
  '전 일정 최신형 16인승/VIP 단독 전용 차량 & 베테랑 기사 (공항 픽업/샌딩 일체 포함)',
  '신짜오투어 베트남 관광청 라이선스 공인 한국어 전담 전문 가이드 풀케어',
  '바나힐 왕복 케이블카 탑승권 + 골든브릿지 + 테마파크 자유이용권 + 바나힐 정상 뷔페 중식',
  '호이안 올드타운 유네스코 입장권 + 투본강 소원배(소원초 유등 포함) + 코코넛 바구니배 탑승권',
  '오행산(마블마운틴) 입장료 및 왕복 엘리베이터 탑승권',
  '여행의 피로를 풀어주는 90분 VIP 프리미엄 전신 아로마 힐링 마사지 (1회)',
  '전 일정 엄선된 특식 (바나힐 뷔페, 호이안 전통 정식, 미케비치 씨푸드 만찬, 미슐랭 분짜 등)',
  '1억원 상당 해외 여행자 보증보험 가입 지원',
  '차량 내 시원한 생수(1일 2병/인) 및 물티슈 상시 제공',
  '24시간 카카오톡 실시간 한국어 고객 지원'
];

const FREE_TOUR_EXCLUDED = [
  '왕복 국제선 항공권 (원하시는 항공편으로 자유 발권 또는 신짜오투어 실시간 최저가 대행)',
  '개인 자유 쇼핑 경비 및 개인 음료/주류 비용',
  '가이드 및 전담 기사 매너팁 (단독 투어 1팀당 1일 $10~$20 권장, 자율 지불)',
  '마사지사 매너팁 (90분 기준 1인 약 $3~$5 / 7만~10만동 현장 지불)',
  '호텔 싱글룸 사용 시 싱글 차지 (독실 사용 시)'
];
